 ...
 *  Copyright (c) 2014      by Ricky Elrod (see note below)
 *
 *  ------------------------------
 *
 *  This file has been modified for hamlib-haskell, which is released under the
 *  same license as "hamlib" itself.
 *
 *  The inclusion of this file within hamlib-haskell is only until this
 *  upstream pull-request gets merged: https://github.com/N0NB/hamlib/pull/2
 *
 *  ------------------------------
 *
